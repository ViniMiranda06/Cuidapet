...
usuario = menus.menu_uc() #Chama a função menu_uc do módulo menus e retorna 
if usuario is not None:
    menus.menupuc(usuario_logado=usuario) # Chama a função menupuc do módulo menus, caso o usuário tenha feito login com sucesso